...
Использует HuggingFace embeddings для обработки документов.
"""
...
from document_processor_langchain import (
...
def main():
    parser = argparse.ArgumentParser(
        description="Массовая загрузка документов из папки в векторную базу данных (HuggingFace)"
    )
    parser.add_argument(
        "folder_path",
